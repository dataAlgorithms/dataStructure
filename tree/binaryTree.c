...
int main()
{
    ...
    printf("\nPreorder traversal using recursive way of binary tree is \n");
    printPreorder(root);
    
    printf("\nPreorder traversal using non-recursive way of binary tree is \n");
    preOrderNonRecursive(root);
    
    printf("\nInorder traversal using recursive way of binary tree is \n");
    printInorder(root);  
    
    printf("\nInorder traversal using non-recursive way of binary tree is \n");
    inOrderNonRecursive(root);
    
    printf("\nPostorder traversal using recursive way of binary tree is \n");
    printPostorder(root);
    
    printf("\nPostorder traversal using non-recursive way of binary tree is \n");
    postOrderNonRecursive(root);
    
    printf("\nLevelorder traversal using recursive way of binary tree is \n");
    printLevelorder(root);
    
    printf("\nLevelorder traversal using non-recursive way of binary tree is \n");
