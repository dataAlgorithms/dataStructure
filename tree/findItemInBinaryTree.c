...
/*
Find item in binary tree using recursive way

Time Complexity: O(n). 
Space Complexity: O(n)
*/
int findInBstUsingRec(struct binaryTreeNode *root, int data) {
    ...
    if (root == NULL)
        ...
        if (data == root->data)
            ...
            temp = findInBstUsingRec(root->left, data);
            if (temp != 0)
                return temp;
            else
                return findInBstUsingRec(root->right, data);
        }
    }
...
/*
find item in binary tree using non recursive way

Time Complexity: O(n)
Space Complexity: O(n)
*/
int findInBstUsingNonRec(struct binaryTreeNode *root, int data) {
...
int main()
{
    ...
    printf("\n%d ", findInBstUsingRec(root, 4));
    printf("\n%d ", findInBstUsingNonRec(root, 4));
    printf("\n%d ", findInBstUsingRec(root, 6));
    printf("\n%d ", findInBstUsingNonRec(root, 6));
